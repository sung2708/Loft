...
const copies: LegalPageCopies = {
  vi: {
    ...
    sections: [
      ...
      { title: "Nội dung nhúng và dịch vụ bên thứ ba", paragraphs: ["YouTube có điều khoản riêng. Khi dùng tính năng này, bạn đồng ý tuân thủ điều khoản áp dụng của dịch vụ đó. Mingly không sở hữu nội dung của YouTube và có thể giới hạn tính năng khi nhà cung cấp yêu cầu hoặc khi cần bảo mật."] },
