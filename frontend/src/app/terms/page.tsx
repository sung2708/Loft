...
const copies: LegalPageCopies = {
  vi: {
    ...
    notice: "Các tính năng có thể thay đổi trong giai đoạn thử nghiệm. Không dùng Mingly cho tình huống cần lưu trữ bản ghi hoặc liên lạc khẩn cấp.",
    sections: [
      ...
      { title: "Nội dung nhúng và dịch vụ bên thứ ba", paragraphs: ["YouTube và Spotify có điều khoản riêng. Khi dùng các tính năng này, bạn đồng ý tuân thủ điều khoản áp dụng của các dịch vụ đó. Mingly không sở hữu nội dung của họ và có thể giới hạn tính năng khi nhà cung cấp yêu cầu hoặc khi cần bảo mật."] },
  ...
  en: {
    ...
    notice: "Features may change while in experimentation. Do not use Mingly where a recording or emergency communication is required.",
    sections: [
      ...
      { title: "Embedded content and third-party services", paragraphs: ["YouTube and Spotify have their own terms. When you use those features, you agree to comply with the applicable third-party terms. Mingly does not own their content and may limit a feature when required by a provider or for security."] },
