...
export const metadata: Metadata = {
  metadataBase: new URL(
    process.env.NEXT_PUBLIC_SITE_URL ?? "https://mingly.site",
  ),
  title: {
  ...
  description:
    "A shared space to talk, watch, listen, and hang out with your people.",
  ...
  openGraph: {
    ...
    url: "/",
    images: [
      { url: "/opengraph-image", width: 1200, height: 630, alt: "Mingly" },
    ],
  },
  twitter: {
