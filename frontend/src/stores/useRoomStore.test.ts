...
const snapshot: RoomSnapshot = {
  room: { id: "room", slug: "123456", name: "Room", owner_id: "owner", allow_guests: true, max_participants: 12, is_locked: false, password_required: false, version: 1, created_at: "2026-09-15T00:00:00Z" },
